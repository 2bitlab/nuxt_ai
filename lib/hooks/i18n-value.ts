...
export function useCreateI18nValue(
    options?: Omit<
        UseMutationOptions<I18nValue | undefined, unknown, Prisma.I18nValueCreateArgs, unknown>,
        'mutationFn'
    >,
...
export function useUpdateI18nValue(
    options?: Omit<
        UseMutationOptions<I18nValue | undefined, unknown, Prisma.I18nValueUpdateArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useUpsertI18nValue(
    options?: Omit<
        UseMutationOptions<I18nValue | undefined, unknown, Prisma.I18nValueUpsertArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
...
export function useDeleteI18nValue(
    options?: Omit<
        UseMutationOptions<I18nValue | undefined, unknown, Prisma.I18nValueDeleteArgs, unknown>,
        'mutationFn'
    >,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
