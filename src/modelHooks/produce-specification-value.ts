...
export function useCreateProduceSpecificationValue(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.ProduceSpecificationValueCreateArgs>(
      ...
      options?: Omit<
        UseMutationOptions<
          CheckSelect<T, ProduceSpecificationValue, Prisma.ProduceSpecificationValueGetPayload<T>> | undefined,
          unknown,
...
export function useCountProduceSpecificationValue<T extends Prisma.ProduceSpecificationValueCountArgs>(
  ...
  const { endpoint, fetch } = getHooksContext()
  return useModelQuery('ProduceSpecificationValue', `${endpoint}/produceSpecificationValue/count`, args, options, fetch)
}
