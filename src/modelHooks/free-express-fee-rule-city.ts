...
export function useCreateFreeExpressFeeRuleCity(
  options?: Omit<
    UseMutationOptions<FreeExpressFeeRuleCity | undefined, unknown, Prisma.FreeExpressFeeRuleCityCreateArgs, unknown>,
    'mutationFn'
  >,
...
export function useUpdateFreeExpressFeeRuleCity(
  options?: Omit<
    UseMutationOptions<FreeExpressFeeRuleCity | undefined, unknown, Prisma.FreeExpressFeeRuleCityUpdateArgs, unknown>,
    'mutationFn'
  >,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
...
export function useUpsertFreeExpressFeeRuleCity(
  options?: Omit<
    UseMutationOptions<FreeExpressFeeRuleCity | undefined, unknown, Prisma.FreeExpressFeeRuleCityUpsertArgs, unknown>,
    'mutationFn'
  >,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
...
export function useDeleteFreeExpressFeeRuleCity(
  options?: Omit<
    UseMutationOptions<FreeExpressFeeRuleCity | undefined, unknown, Prisma.FreeExpressFeeRuleCityDeleteArgs, unknown>,
    'mutationFn'
  >,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
...
export function useAggregateFreeExpressFeeRuleCity<T extends Prisma.FreeExpressFeeRuleCityAggregateArgs>(
  ...
  const { endpoint, fetch } = getHooksContext()
  return useModelQuery('FreeExpressFeeRuleCity', `${endpoint}/freeExpressFeeRuleCity/aggregate`, args, options, fetch)
}
