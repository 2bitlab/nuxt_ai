...
export function useFindManyExpressFeeRule<T extends Prisma.ExpressFeeRuleFindManyArgs>(
  ...
  const { endpoint, fetch } = getHooksContext()
  return useModelQuery('ExpressFeeRule', `${endpoint}/expressFeeRule/findMany`, args, options, fetch, optimisticUpdate)
}
...
export function useFindFirstExpressFeeRule<T extends Prisma.ExpressFeeRuleFindFirstArgs>(
  ...
  const { endpoint, fetch } = getHooksContext()
  return useModelQuery('ExpressFeeRule', `${endpoint}/expressFeeRule/findFirst`, args, options, fetch, optimisticUpdate)
}
