...
export function useCreateManyShop(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.ShopCreateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.ShopCreateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
...
export function useUpdateManyShop(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.ShopUpdateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.ShopUpdateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
...
export function useDeleteManyShop(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.ShopDeleteManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.ShopDeleteManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
