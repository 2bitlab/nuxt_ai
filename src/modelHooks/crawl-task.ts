...
export function useCreateCrawlTask(
  options?: Omit<UseMutationOptions<CrawlTask | undefined, unknown, Prisma.CrawlTaskCreateArgs, unknown>, 'mutationFn'>,
...
export function useUpdateCrawlTask(
  options?: Omit<UseMutationOptions<CrawlTask | undefined, unknown, Prisma.CrawlTaskUpdateArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
...
export function useUpsertCrawlTask(
  options?: Omit<UseMutationOptions<CrawlTask | undefined, unknown, Prisma.CrawlTaskUpsertArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
...
export function useDeleteCrawlTask(
  options?: Omit<UseMutationOptions<CrawlTask | undefined, unknown, Prisma.CrawlTaskDeleteArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
