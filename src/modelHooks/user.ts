...
export function useCreateManyUser(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.UserCreateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.UserCreateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
...
export function useUpdateManyUser(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.UserUpdateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.UserUpdateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
...
export function useDeleteManyUser(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.UserDeleteManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.UserDeleteManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
