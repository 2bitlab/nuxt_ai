...
export function useCreateManySession(
  options?: Omit<UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionCreateManyArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.SessionCreateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.SessionCreateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
...
export function useUpdateManySession(
  options?: Omit<UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionUpdateManyArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.SessionUpdateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.SessionUpdateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
...
export function useDeleteManySession(
  options?: Omit<UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SessionDeleteManyArgs, unknown>, 'mutationFn'>,
  invalidateQueries: boolean = true,
  optimisticUpdate: boolean = false
) {
  const { endpoint, fetch } = getHooksContext()
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.SessionDeleteManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.SessionDeleteManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
