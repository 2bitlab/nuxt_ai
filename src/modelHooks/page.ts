...
export function useCreateManyPage(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.PageCreateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.PageCreateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
...
export function useUpdateManyPage(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.PageUpdateManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.PageUpdateManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
...
export function useDeleteManyPage(
  ...
  const mutation = {
    ...
    async mutateAsync<T extends Prisma.PageDeleteManyArgs>(
      ...
      options?: Omit<
        UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.PageDeleteManyArgs>, unknown>,
        'mutationFn'
      >
    ) {
      return (await _mutation.mutateAsync(args, options as any)) as Prisma.BatchPayload
