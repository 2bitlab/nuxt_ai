...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.createMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.deleteMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findFirstOrThrow: procedure
      .input($Schema.PhysicalProduceInputSchema.findFirst)
      .query(({ ctx, input }) => checkRead(db(ctx).physicalProduce.findFirstOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.PhysicalProduceInputSchema)['findFirst'],
    ...
    findUniqueOrThrow: procedure
      .input($Schema.PhysicalProduceInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).physicalProduce.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.PhysicalProduceInputSchema)['findUnique'],
    ...
    updateMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.updateMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).physicalProduce.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
