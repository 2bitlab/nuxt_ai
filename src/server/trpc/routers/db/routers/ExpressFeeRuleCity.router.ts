...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRuleCity.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRuleCity.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findFirstOrThrow: procedure
      .input($Schema.ExpressFeeRuleCityInputSchema.findFirst)
      .query(({ ctx, input }) => checkRead(db(ctx).expressFeeRuleCity.findFirstOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.ExpressFeeRuleCityInputSchema)['findFirst'],
    ...
    findUniqueOrThrow: procedure
      .input($Schema.ExpressFeeRuleCityInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).expressFeeRuleCity.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.ExpressFeeRuleCityInputSchema)['findUnique'],
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRuleCity.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRuleCity.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
