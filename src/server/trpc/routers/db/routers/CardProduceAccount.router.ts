...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).cardProduceAccount.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).cardProduceAccount.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findFirstOrThrow: procedure
      .input($Schema.CardProduceAccountInputSchema.findFirst)
      .query(({ ctx, input }) => checkRead(db(ctx).cardProduceAccount.findFirstOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.CardProduceAccountInputSchema)['findFirst'],
    ...
    findUniqueOrThrow: procedure
      .input($Schema.CardProduceAccountInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).cardProduceAccount.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.CardProduceAccountInputSchema)['findUnique'],
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).cardProduceAccount.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).cardProduceAccount.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
