...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    aggregate: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).produceSpecificationValue.aggregate(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    findFirst: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).produceSpecificationValue.findFirst(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    findMany: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).produceSpecificationValue.findMany(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    findUnique: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).produceSpecificationValue.findUnique(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    groupBy: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).produceSpecificationValue.groupBy(input as any))) as ProcReturns<
      'query',
      Proc,
