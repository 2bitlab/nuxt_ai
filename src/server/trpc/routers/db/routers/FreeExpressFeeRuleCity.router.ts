...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    aggregate: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).freeExpressFeeRuleCity.aggregate(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    findFirst: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).freeExpressFeeRuleCity.findFirst(input as any))) as ProcReturns<
      'query',
      Proc,
    ...
    findUnique: procedure
      ...
      .query(({ ctx, input }) => checkRead(db(ctx).freeExpressFeeRuleCity.findUnique(input as any))) as ProcReturns<
      'query',
      Proc,
