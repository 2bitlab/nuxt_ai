...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).configValue.createMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).configValue.deleteMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    updateMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).configValue.updateMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
