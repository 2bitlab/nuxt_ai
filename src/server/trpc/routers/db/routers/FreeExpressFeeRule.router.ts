...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).freeExpressFeeRule.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).freeExpressFeeRule.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findFirstOrThrow: procedure
      .input($Schema.FreeExpressFeeRuleInputSchema.findFirst)
      .query(({ ctx, input }) => checkRead(db(ctx).freeExpressFeeRule.findFirstOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.FreeExpressFeeRuleInputSchema)['findFirst'],
    ...
    findUniqueOrThrow: procedure
      .input($Schema.FreeExpressFeeRuleInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).freeExpressFeeRule.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.FreeExpressFeeRuleInputSchema)['findUnique'],
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).freeExpressFeeRule.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).freeExpressFeeRule.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
