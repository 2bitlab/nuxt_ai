...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).verificationToken.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).verificationToken.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findFirstOrThrow: procedure
      .input($Schema.VerificationTokenInputSchema.findFirst)
      .query(({ ctx, input }) => checkRead(db(ctx).verificationToken.findFirstOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.VerificationTokenInputSchema)['findFirst'],
    ...
    findUniqueOrThrow: procedure
      .input($Schema.VerificationTokenInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).verificationToken.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.VerificationTokenInputSchema)['findUnique'],
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).verificationToken.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).verificationToken.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
