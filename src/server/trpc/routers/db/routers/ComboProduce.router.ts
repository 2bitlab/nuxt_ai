...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).comboProduce.createMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).comboProduce.deleteMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    updateMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).comboProduce.updateMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
