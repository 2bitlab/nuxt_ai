...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).producePrice.createMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).producePrice.deleteMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    updateMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).producePrice.updateMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
