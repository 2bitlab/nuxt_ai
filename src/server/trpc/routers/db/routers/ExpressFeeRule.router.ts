...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
  ...
  return router({
    ...
    createMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.createMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.create(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    deleteMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.deleteMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    delete: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.delete(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    findUniqueOrThrow: procedure
      .input($Schema.ExpressFeeRuleInputSchema.findUnique)
      .query(({ ctx, input }) => checkRead(db(ctx).expressFeeRule.findUniqueOrThrow(input as any))) as ProcReturns<
      'query',
      Proc,
      (typeof $Schema.ExpressFeeRuleInputSchema)['findUnique'],
    ...
    updateMany: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.updateMany(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    update: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.update(input as any))) as ProcReturns<
      'mutation',
      Proc,
    ...
    upsert: procedure
      ...
      .mutation(async ({ ctx, input }) => checkMutate(db(ctx).expressFeeRule.upsert(input as any))) as ProcReturns<
      'mutation',
      Proc,
